...
<head>
    ...
    <title>Data Kelas | Admin M-GOLEM</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data Kelas <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addData"><i class="fa fa-plus-circle"></i> Add</button></strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                      @foreach($kelas as $key => $data)
                                        <tr>
                                          ...
                                          <td>
                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editData" data-id_kelas = "{{ $data->id_kelas }}" data-nama_kelas="{{ $data->nama_kelas }}"><i class="fa fa-edit"></i> Edit</button>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteData" data-id_kelas = "{{ $data->id_kelas }}"><i class="fa fa-trash"></i> Delete</button>
                                          </td>
                                        </tr>
                                      @endforeach
                                    </tbody>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form id="modal-form-add" action="{{ route('data-kelas.store') }}" method="post" role="form">
                  {{ csrf_field() }}
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <form id="modal-form-edit" method="post" action="{{ route('data-kelas.update', 'update') }}">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
              <div class="modal-body">
                    <input type="hidden" name="id_kelas" id="cat_id" value="">
        ...
        $(document).ready(function() {
          ...
          formAdd.submit(function (e) {
                    ...
                    if( res.error == 0 ){
                      ...
                      swal(
                        ...
                        res.message,
                          ...
                          if(OK){
                            window.location.href = "{{ route('dataKelasAdmin') }}";
                          }
                        });
                    } else{
                        $('#addData').modal('hide');
            ...
            $('#editData').on('show.bs.modal', function (event) {
              ...
              var id_kelas   = button.data('id_kelas') // Extract info from data-* attributes
              ...
              modal.find('.modal-body #cat_id').val(id_kelas)
