...
<head>
    ...
    <title>Data Teknisi | Admin M-GOLEM</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data Teknisi <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addData"><i class="fa fa-plus-circle"></i> Add</button></strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @foreach($teknisi as $key => $data)
                                          <tr>
                                            <td>{{ ++$key }}</td>
                                            <td>{{ $data->username }}</td>
                                            <td>{{ $data->nama_teknisi }}</td>
                                            <td>
                                              <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editData" data-username = "{{ $data->username }}" data-nama_teknisi="{{ $data->nama_teknisi }}"><i class="fa fa-edit"></i> Edit</button>
                                              <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteData" data-username = "{{ $data->username }}"><i class="fa fa-trash"></i> Delete</button>
                                            </td>
                                          </tr>
                                        @endforeach
                                    </tbody>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="fa fa-plus-circle"></span> Add Data Teknisi</h4>
              </div>
              <div class="modal-body">
                <form id="modal-form-add" action="{{ route('data-teknisi.store') }}" method="post" role="form">
                  {{ csrf_field() }}
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <form id="modal-form-edit" method="post" action="{{ route('data-teknisi.update', 'update') }}">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
              <div class="modal-body">
                    <input type="hidden" name="username" id="cat_id" value="">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <form id="modal-form-delete" method="post" action="{{ route('data-teknisi.destroy', 'destroy') }}">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
              <div class="modal-body">
                    <input type="hidden" name="username" id="cat_id" value="">
        ...
        $(document).ready(function() {
          ...
          formAdd.submit(function (e) {
                    ...
                    if( res.error == 0 ){
                      ...
                      swal(
                        ...
                        res.message,
                          ...
                          if(OK){
                            window.location.href = "{{ route('dataTeknisiAdmin') }}";
                          }
                        });
                    }else if( res.error == 1 ){
                        $('#editData').modal('hide');
            ...
            $('#editData').on('show.bs.modal', function (event) {
              ...
              var nama_teknisi = button.data('nama_teknisi')

              // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
              // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
              var modal = $(this)
              modal.find('.modal-body #username').val(username)
              modal.find('.modal-body #nama_teknisi').val(nama_teknisi)
              modal.find('.modal-body #cat_id').val(username)
