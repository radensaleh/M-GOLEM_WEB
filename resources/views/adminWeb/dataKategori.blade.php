...
<head>
    ...
    <title>Data Kategori | Admin M-GOLEM</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data Kategori <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addData"><i class="fa fa-plus-circle"></i> Add</button></strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach($kategori as $key => $data)
                                          <tr>
                                            ...
                                            <td>
                                              <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editData" data-id_kategori = "{{ $data->id_kategori }}" data-nama_kategori="{{ $data->nama_kategori }}"><i class="fa fa-edit"></i> Edit</button>
                                              <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteData" data-id_kategori = "{{ $data->id_kategori }}"><i class="fa fa-trash"></i> Delete</button>
                                            </td>
                                          </tr>
                                        @endforeach
                                    </tbody>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="fa fa-plus-circle"></span> Add Data Kategori</h4>
              </div>
              <div class="modal-body">
                <form id="modal-form-add" action="{{ route('data-kategori.store') }}" method="post" role="form">
                  {{ csrf_field() }}
                  <div class="form-group has-success">
                    <label for="id_kategori" class="form-control-label">Id Kategori</label>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <form id="modal-form-edit" method="post" action="{{ route('data-kategori.update', 'update') }}">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
              <div class="modal-body">
                    <input type="hidden" name="id_kategori" id="cat_id" value="">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <form id="modal-form-delete" method="post" action="{{ route('data-kategori.destroy', 'destroy') }}">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
              <div class="modal-body">
                    <input type="hidden" name="id_kategori" id="cat_id" value="">
        ...
        $(document).ready(function() {
          ...
          formAdd.submit(function (e) {
                    ...
                    if( res.error == 0 ){
                      ...
                      swal(
                        ...
                        res.message,
                          ...
                          if(OK){
                            window.location.href = "{{ route('dataKategoriAdmin') }}";
                          }
                        });
                    } else{
                        $('#addData').modal('hide');
            ...
            $('#editData').on('show.bs.modal', function (event) {
              ...
              var id_kategori   = button.data('id_kategori') // Extract info from data-* attributes
              ...
              modal.find('.modal-body #cat_id').val(id_kategori)
